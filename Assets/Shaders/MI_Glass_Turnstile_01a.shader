Shader "Unreal/MI_Glass_Turnstile_01a"
{
    Properties
    {
		...
		Material_Texture2D_0( "TX_Glass_01a_ALB", 2D ) = "white" {}
		Material_Texture2D_1( "TX_Glass_01a_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Glass_Turnstile_01a.hlsl"
