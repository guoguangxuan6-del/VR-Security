Shader "Unreal/MI_Wall_Subway_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "Base Color", 2D ) = "white" {}
		Material_Texture2D_3( "Red_ALB", 2D ) = "white" {}
		Material_Texture2D_4( "TX_Mixmap_01a", 2D ) = "white" {}
		Material_Texture2D_5( "0_RMA", 2D ) = "white" {}
		Material_Texture2D_6( "Red_RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wall_Subway_01a.hlsl"
